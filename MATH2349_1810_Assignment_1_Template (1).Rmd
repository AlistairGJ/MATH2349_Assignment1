...
# Check the String
head(abaloneDSDesc, n=15)
# Remove "\t"

abaloneDSDesc <- strsplit(abaloneDSDesc, "\n")
abaloneDSDesc
abaloneDSDesc <- strsplit(abaloneDSDesc, "\r")

str = str_replace(abaloneDSDesc, "\t", "")
str


```

* This does NOT work - need to READ

```{r}
txtTest <- pdf_text("30119561_Releases_Notes_SparkControl_V1_8.pdf")
txtTest
txtTest2 <- strsplit(txtTest, "\n")
txtTest2
head(txtTest2[[5]])
txtTest2[[5]]
